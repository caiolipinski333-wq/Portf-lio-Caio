CREATE DATABASE EXERCICIO_BIG_DATA;

  USE EXERCICIO_BIG_DATA;
...
SELECT NOME FROM FUNCIONARIOS WHERE DEPARTAMENTO='ROUPA' OR DEPARTAMENTO='FILMES';
SELECT NOME FROM FUNCIONARIOS WHERE DEPARTAMENTO='LAR' OR DEPARTAMENTO='FILMES';
SELECT NOME FROM FUNCIONARIOS WHERE SEXO='masculino' AND DEPARTAMENTO='jardim';
SELECT NOME FROM FUNCIONARIOS WHERE SEXO='feminino' AND DEPARTAMENTO='jardim';
SELECT EMAIL FROM FUNCIONARIOS WHERE DEPARTAMENTO='JARDIM';
SELECT NOME AS COLABORADORES_AS,EMAIL FROM FUNCIONARIOS WHERE DEPARTAMENTO='computadores';
SELECT NOME AS COLABORADORES_AS,EMAIL,CARGO FROM FUNCIONARIOS WHERE DEPARTAMENTO='ROUPAS';
